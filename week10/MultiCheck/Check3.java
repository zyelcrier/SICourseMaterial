public class Check3{
    public static void main(String[] args){
         System.out.println("\n\nWelcome to While Loop CheckIn and Conditional CheckIN\n\n");
        ...
        //Print out all the results of the TODOO's
         ...
         //TODO #2 -  use a while loop to keep rolling a 7 sided die till the roll is 7 
         
         //TODO #3 -  prompt the user if they would like to do math (yes or no) set it to a boolean value
         //Hint remember boolean is either true or false
         ...
         //TODO #6a - keep rolling while the user choice is true and add all the values of the dice rolls 
         // when the user enters anything but yes set user choice to false
        
         //Send a 3 in the chat when your done with these todos
    }
}